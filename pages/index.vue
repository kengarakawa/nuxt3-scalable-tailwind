...
import { config } from 'process';
  ...
  const { data:posts , error , refresh , pending } = await useWpApi().getPosts()
  ...
  <main>
    ...
    <section class="bg-gray-100">
        <div class="container flex flex-wrap items-center py-12 mx-auto">
          ...
          >
            <img
              src="~/assets/images/arakawacow.jpg"
              alt="Samit Koyom"
          ...
          <div>
            ...
            <a
              ...
              class="inline-flex items-center gap-2 px-4 py-2 text-white rounded bg-sky-500 bg-primary-500 hover:bg-primary-600"
            >
              <svg
    ...
    <section class="container mx-auto">
      <div class="container py-10">
        <div class="grid gap-10 sm:grid-cols-3">
          <!-- <BlogGrid v-for="(post,index) in posts" :key="post.id"
            :title="post.title.rendered"
            :image="post._embedded['wp:featyredmedia'][0].source_url"
